...
class DeeplabDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        #   从文件中读取图像
        # -------------------------------#
        jpg = Image.open(os.path.join(os.path.join(self.dataset_path, "images_png"), name + ".png"))
        png = Image.open(os.path.join(os.path.join(self.dataset_path, "masks_png"), name + ".png"))
        # -------------------------------#
        #   数据增强
        # -------------------------------#
